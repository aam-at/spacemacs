...
| Key binding   | Description                                       |
|---------------+---------------------------------------------------|
| ~M-RET M-RET~ | org-meta-return (dwim return)                     |
...
| Key binding | Description                                         |
|-------------+-----------------------------------------------------|
| ~SPC m T m~ | Toggle org-modern in current buffer                 |
| ~SPC m T M~ | Toggle org-modern in all org and org agenda buffers |
...
| Key binding | Description                     |
|-------------+---------------------------------|
| ~SPC m r m~ | Mark selection with default pen |
| ~SPC m r g~ | Mark selection with green pen   |
| ~SPC m r y~ | Mark selection with yellow pen  |
| ~SPC m r r~ | Mark selection with red pen     |
| ~SPC m r o~ | Open selected highlight         |
| ~SPC m r k~ | Go to the previous highlight    |
| ~SPC m r j~ | Go to the next highlight        |
| ~SPC m r d~ | Delete selected highlight       |
